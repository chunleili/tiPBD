def parse_cli():
    ...
    parser.add_argument("--no_json", action="store_true", default=False, help="do not use json config file")
    parser.add_argument(
        "--scene_file", type=str, default="", help="manually specify scene file, if not specified, use gui to select"
    )
    parser.add_argument("--arch", type=str, default="cuda", help="backend(arch) of taichi)")
    parser.add_argument("--debug", action="store_true", default=False, help="debug mode")
    parser.add_argument("--device_memory_fraction", type=float, default=0.5, help="device memory fraction")
    parser.add_argument("--kernel_profiler", action="store_true", default=False, help="enable kernel profiler")
    parser.add_argument("--use_dearpygui", action="store_true", default=False, help="use dearpygui as gui")
    parser.add_argument("--use_webui", action="store_true", default=False, help="use webui")
    parser.add_argument("--use_solver_main", action="store_true", default=True, help="use provided solver_main")
