...
def test_amg(A, b, postfix=""):
    ...
    print("res14 SA+CG smooth='energy'",(res14[-1]/res14[0])**(1.0/(len(res14)-1)))
    ...
    print("res15 SA+CG 20+last",(res15[-1]/res15[0])**(1.0/(len(res15)-1)))
