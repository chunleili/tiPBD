...
def solve_FEMTetraConstraint(
    ...
    sum_normGradC = (
        invMass0 * np.linalg.norm(gradC[0]) ** 2
        + invMass1 * np.linalg.norm(gradC[1]) ** 2
        + invMass2 * np.linalg.norm(gradC[2]) ** 2
        + invMass3 * np.linalg.norm(gradC[3]) ** 2
    )
...
def test_solve_FEMTetraConstraint():
    ...
    x1 = np.array([0, -0.75, -0.75])
    x2 = np.array([0.34482758620689657, -0.76977695999999796, -0.37500000000000000])
    x3 = np.array([0.34482758620689657, -0.39477695999999796, -0.75000000000000000])
